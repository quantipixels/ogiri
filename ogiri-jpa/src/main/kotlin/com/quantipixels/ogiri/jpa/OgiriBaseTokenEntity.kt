 ...
 */
@MappedSuperclass
abstract class OgiriBaseTokenEntity(
    /** Token expiration time (UTC) - should be indexed for cleanup queries. */
    @Column(name = "expiry_at", nullable = false) override var expiryAt: Instant,
) : OgiriBaseToken() {

  /** No-arg constructor required by JPA for proxying — not for use in application code. */
