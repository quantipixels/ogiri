...
object TestFixtures {
  ...
  fun testUser(
      ...
      object : OgiriUser {
         ...
         *
         * @return `true` if the account is not expired, `false` otherwise. This implementation
         *   always returns `true` for the test user fixture.
         */
  ...
  class TokenBuilder(
     ...
     *
     * @param lastUsedAt The Instant when the token was last used, or `null` if it has never been
     *   used.
     * @return This builder instance.
     */
