 ...
 *
 * This demonstrates how Java users should implement their own Token class
 * for JPA/Hibernate persistence. The class extends BaseToken and provides
 * JPA annotations for column mapping and constraints.
 *
 * All properties implement the abstract/open properties from BaseToken,
 * and the class includes getters/setters for fields that TokenService updates.
 */
@Entity
@Table(
  name = "user_tokens",
...
public class SampleToken extends BaseToken {
   ...
   * Auto-populated by Hibernate on insert.
   */
  @CreationTimestamp
   ...
   * Auto-updated by Hibernate on any modification.
   */
  @UpdateTimestamp
   ...
   * Updated by TokenService during rotation.
   */
   ...
   * Allows old token to work briefly while new token is issued.
   */
